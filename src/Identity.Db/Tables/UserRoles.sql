...
GO
CREATE NONCLUSTERED INDEX [IX_UserRoles_Roles_RoleId] ON [dbo].[UserRoles] ([RoleId])
GO
CREATE NONCLUSTERED INDEX [IX_UserRoles_Users_UserId] ON [dbo].[UserRoles] ([UserId])
GO